...
sub _banner    { make_banner($_[0]->{Width}, $_[0]->{BannerString}) }
sub _srcbanner { make_banner($_[0]->{Width}, $_[0]->{SourceString}) }
sub _triangle  { make_triangle($_[0]->{Width}) }
sub _siertri   { make_siertri($_[0]->{Width}) }
...
my %builtin_shapes = (
   'triangle'   => \&_triangle, 'siertri'    => \&_siertri,
   'banner'     => \&_banner,   'srcbanner'  => \&_srcbanner
);
